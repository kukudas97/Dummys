                   ...
                   <div class="warning-table" style="padding-bottom: 30px;"> 
                  	<div class="card">
                        ...
                        <h3 class="margin15" >누적 신고</h3>
                            <table id="reportWarningUsers" class="table table-striped table-bordered" style="text-align: center; align-items: center; justify-content: center;">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                  <c:forEach items="${reportWarningCnt}" var="reportWarningCnt">
										<tr>
											<td><c:out value="${reportWarningCnt.receive_id}" /></td>
											<td><c:out value="${reportWarningCnt.warning_cnt}" /></td>
											<td><button type="button" class="adminReportBtn" value="${reportWarningCnt.receive_id}">정지</button></td>
										</tr>
								 </c:forEach>
                                </tbody>
                            </table>
                      ...
                      <div class="col-lg-5" style="margin:auto; display: inline">
                            ...
                            <table id="blockedUsers" class="table table-striped table-bordered" style="text-align: center; align-items: center; justify-content: center;">
                                <thead>
                                    <tr>
                                        <th scope="col">USERID</th>
                                        <th scope="col">처리</th>
                                ...
                                <tbody>
                                  <c:forEach items="${getBlockUsers}" var="getBlockUsers">
										<tr>
											...
											<td><button type="button" class="blockReleaseBtn" value="${getBlockUsers}">해제</button></td> 
										</tr>
								 </c:forEach>
                                </tbody>
                            </table>
